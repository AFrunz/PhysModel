...
# Project:  Model.pro
# Template: app
# Command: C:\Qt\Qt5.14.2\5.14.2\mingw73_32\bin\qmake.exe -o Makefile Model.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: Model.pro C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
